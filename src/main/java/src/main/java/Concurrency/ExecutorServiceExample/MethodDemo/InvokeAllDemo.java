package src.main.java.Concurrency.ExecutorServiceExample.MethodDemo;
...
//https://blog.csdn.net/baidu_23086307/article/details/51740852
public class InvokeAllDemo {
    ...
    public static void main(String[] args) {
        try {
            InvokeAllDemo it = new InvokeAllDemo();
